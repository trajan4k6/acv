 ...
 *
  FROM (
   SELECT  --'1' FLAG,
        ...
        CASE WHEN AS_AT_DATE=LOGO_MIN_AS_AT_DATE   OR MONTHS_BETWEEN(LOGO_PRE_AS_AT_DATE,AS_AT_DATE)>12 THEN 1 ELSE 0 END NEW_LOGO,
        0 CHURN,
        ...
        CASE WHEN LOGO_MIN_AS_AT_DATE<>INV_MIN_AS_AT_DATE AND PRODUCT_TYPE='Subscription' AND INV_MIN_AS_AT_DATE=AS_AT_DATE  THEN 1 ELSE 0 END CROSS_SELL,
        CASE WHEN LOGO_MIN_AS_AT_DATE<>REGION_MIN_AS_AT_DATE AND PRODUCT_TYPE='Subscription' AND REGION_MIN_AS_AT_DATE=AS_AT_DATE  THEN 1 ELSE 0 END UPSELL,
        0 MODULE_DROP,
        CASE WHEN (LOGO_MIN_AS_AT_DATE<>STATE_MIN_AS_AT_DATE  AND STATE_MIN_AS_AT_DATE=AS_AT_DATE) OR MONTHS_BETWEEN(AS_AT_DATE,NVL(STATE_PRE_AS_AT_DATE,AS_AT_DATE))>1 THEN 1 ELSE 0 END NEW_LOCATION,
        0 LOCATION_DROP,
...
WHERE   (INV_MONTHS_DIFF>1 OR REGION_MONTHS_DIFF>1 )   AND (INV_MAX_AS_AT_DATE=AS_AT_DATE OR REGION_MAX_AS_AT_DATE=AS_AT_DATE) AND PRODUCT_TYPE='Subscription'
UNION ALL
  SELECT  --'1' FLAG,
        LOGO_MAX_AS_AT_DATE,INV_MAX_AS_AT_DATE,STATE_MAX_AS_AT_DATE,
        FIRM_ID,
