 ...
 *
  FROM (
   SELECT  --'1' FLAG,
        LOGO_MIN_AS_AT_DATE,INV_MAX_AS_AT_DATE,STATE_MAX_AS_AT_DATE,STATE_PRE_AS_AT_DATE,STATE_POST_AS_AT_DATE,
        FIRM_ID,
        LOOKUP_ID,
        FIRM_NAME,
        FIRM_TIER,
        ...
        CASE WHEN LOGO_MIN_AS_AT_DATE<>INV_MIN_AS_AT_DATE AND INV_MIN_AS_AT_DATE=AS_AT_DATE  THEN 1 ELSE 0 END CROSS_SELL,
        CASE WHEN LOGO_MIN_AS_AT_DATE<>REGION_MIN_AS_AT_DATE  AND REGION_MIN_AS_AT_DATE=AS_AT_DATE  THEN 1 ELSE 0 END UPSELL,
        0 MODULE_DROP,
        CASE WHEN (LOGO_MIN_AS_AT_DATE<>STATE_MIN_AS_AT_DATE AND  FIRM_MIN_AS_AT_DATE<>STATE_MIN_AS_AT_DATE  AND STATE_MIN_AS_AT_DATE=AS_AT_DATE) OR MONTHS_BETWEEN(AS_AT_DATE,NVL(STATE_PRE_AS_AT_DATE,AS_AT_DATE))>1 THEN 1 ELSE 0 END NEW_LOCATION,
        0 LOCATION_DROP,
        ...
        CASE WHEN (LOGO_MIN_AS_AT_DATE<>FIRM_MIN_AS_AT_DATE  AND FIRM_MIN_AS_AT_DATE=AS_AT_DATE) OR MONTHS_BETWEEN(AS_AT_DATE,NVL(FIRM_MIN_AS_AT_DATE,AS_AT_DATE))>1 THEN 1 ELSE 0 END NEW_TEAM,
        0 TEAM_DROPPED
FROM    
        CTE
WHERE 
