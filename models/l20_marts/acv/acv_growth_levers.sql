...
(SELECT
 ...
 , START_DATE,END_DATE
 FROM
(SELECT FIRM_ID,LOOKUP_ID,FIRM_NAME,FIRM_TIER,PARENT_FIRM_TYPE,FIRM_CATEGORY,INVENTORY_DESCRIPTION,ASSET_CLASS,PRODUCT_TYPE,REGION,COUNTRY,STATE,'GBP' CURRENCY,MAX(START_DATE) START_DATE,MAX(END_DATE) END_DATE,
		AS_AT_DATE,SUM(ACV_GBP) ACV_GBP
 FROM   {{ref('stg_acv_values')}}  
 WHERE PRODUCT_TYPE ='Subscription'
GROUP BY FIRM_ID,LOOKUP_ID,FIRM_NAME,FIRM_TIER,PARENT_FIRM_TYPE,FIRM_CATEGORY,INVENTORY_DESCRIPTION,ASSET_CLASS,PRODUCT_TYPE,REGION,COUNTRY,STATE,AS_AT_DATE--,CURRENCY,START_DATE,END_DATE
)
