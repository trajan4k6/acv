...
with final as (
   SELECT 
       ...
       CASE WHEN A.ROW_TYPE IN ('NEW_LOGO','CROSS_SELL','UPSELL','NEW_LOCATION','PRICE_INCREASE','NEW_TEAM','FLAT_RENEWAL') THEN  A.ACV_GBP
            WHEN A.ROW_TYPE IN ('NO_CHANGE') THEN 0
         ELSE CASE WHEN A.ACV_GBP>1 THEN -1*A.ACV_GBP ELSE A.ACV_GBP END END ACV_GBP
    FROM 
