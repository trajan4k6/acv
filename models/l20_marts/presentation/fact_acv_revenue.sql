...
with final as (
   SELECT 
       ...
       A.ROW_TYPE,
       CASE WHEN A.ROW_TYPE IN ('NEW_LOGO','NO_CHANGE','CROSS_SELL','UPSELL','NEW_LOCATION','PRICE_INCREASE','NEW_TEAM')
       THEN  NVL(S.ACV_GBP,A.ACV_GBP) ACV_GBP ELSE -1*NVL(S.ACV_GBP,A.ACV_GBP) END ACV_GBP
    FROM 
