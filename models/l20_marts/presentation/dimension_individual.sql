...
SELECT DIMENSION_INDIVIDUAL_KEY, TO_CHAR(CONTACTFIRM_ID), CONTACT_TITLE, CONTACT_FIRSTNAME, CONTACT_LASTNAME, EMAIL_ADDRESS, LINKEDIN, IS_ACTIVE, DIMENSION_FIRM_KEY, DATASOURCE_ID
FROM {{ ref('preqin_dimension_individual') }} I

--2 + any Unmapped Salesforce Contacts to Primary\Master Contact
UNION
SELECT DIMENSION_CONTACT_KEY, TO_CHAR(crm_contact_firm_id_c), TITLE, FIRST_NAME, LAST_NAME, EMAIL_ADDRESS, LINKEDIN, IS_ACTIVE, 
...
UNION
SELECT DIMENSION_USER_KEY, Identity CONTACTFIRM_ID, TITLE, FIRST_NAME, LAST_NAME, NULL, NULL, FALSE, 
