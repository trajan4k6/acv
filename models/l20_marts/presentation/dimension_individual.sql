...
UNION
SELECT DIMENSION_CONTACT_ACCOUNT_KEY, TO_CHAR(crm_contact_firm_id), NULL, TITLE, FIRST_NAME, LAST_NAME, EMAIL_ADDRESS, LINKEDIN, IS_ACTIVE, Is_Primary_Firm, HasOptedOutOfEmail, DoNotCall, Phone, MobilePhone, C.TOTAL_COMMS, C.TOTAL_COMMS_L12M,
...
UNION
SELECT DIMENSION_USER_KEY, Identity CONTACTFIRM_ID, NULL, TITLE, FIRST_NAME, LAST_NAME, NULL, NULL, FALSE, FALSE, NULL, NULL, NULL, NULL, NULL, NULL,
