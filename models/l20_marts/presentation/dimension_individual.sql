...
SELECT '-1' AS DIMENSION_INDIVIDUAL_KEY, NULL AS CONTACTFIRM_ID, NULL AS CRM_Contact_ID, NULL CONTACT_TITLE, NULL CONTACT_FIRSTNAME, NULL AS CONTACT_LASTNAME, NULL AS EMAIL_ADDRESS, NULL AS LINKEDIN, FALSE AS IS_ACTIVE, FALSE AS Is_Primary_Firm, NULL AS HasOptedOutOfEmail, NULL AS  DoNotCall, NULL AS TOTAL_COMMS, NULL AS TOTAL_COMMS_L12M, '-1' AS DIMENSION_FIRM_KEY,  NULL AS DATASOURCE_ID
UNION
--1.Primary Contact list from Core
SELECT DIMENSION_INDIVIDUAL_KEY, TO_CHAR(I.CONTACTFIRM_ID), I.CONTACT_ID, I.CONTACT_TITLE, I.CONTACT_FIRSTNAME, I.CONTACT_LASTNAME, I.EMAIL_ADDRESS, I.LINKEDIN, I.IS_ACTIVE, C.Is_Primary_Firm, C.HasOptedOutOfEmail, C.DoNotCall, C.TOTAL_COMMS, C.TOTAL_COMMS_L12M, I.DIMENSION_FIRM_KEY, I.DATASOURCE_ID
...
UNION
SELECT DIMENSION_CONTACT_ACCOUNT_KEY, TO_CHAR(crm_contact_firm_id), NULL, TITLE, FIRST_NAME, LAST_NAME, EMAIL_ADDRESS, LINKEDIN, IS_ACTIVE, Is_Primary_Firm, HasOptedOutOfEmail, DoNotCall, C.TOTAL_COMMS, C.TOTAL_COMMS_L12M,
...
UNION
SELECT DIMENSION_USER_KEY, Identity CONTACTFIRM_ID, NULL, TITLE, FIRST_NAME, LAST_NAME, NULL, NULL, FALSE, FALSE, NULL, NULL, NULL, NULL,
